...
import Subscribers_Logo_Green from "@/assets/subscribers_logo_green";
...
const Dynamics = () => {
  return (
    <div className="rounded-lg bg-white py-7 inline-block ml-3 w-7/12 pr-5 h-[490px] pb-10">
      <div className="flex justify-between">
        <div className="flex">
          ...
          <div className="dropdown dropdown-bottom dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="text-[#512040] dropdown-content menu p-2 shadow-[0px_4px_35px_0_rgba(0,0,0,0.1)] bg-white rounded-box w-52 z-50 text-black text-sm font-medium"
            >
              <Link className="flex justify-end" href="/account_subscription">
                Динамика подписок{" "}
                <Image
                  src={Subscribers_Logo_Green}
                  alt="subscribers"
                  width={20}
                  height={20}
                  className="ml-2"
      ...
      <h1 className="ml-8 font-light">
        <span className="text-[#19C20A] text-xl font-semibold mr-1">21%</span>
        средняя доходность
      </h1>
      <LineChart />
    </div>
