...
import Income_Logo from "@/assets/income";
  ...
  return (
    <div className="rounded-lg bg-white py-7 inline-block ml-3 w-7/12 pr-5 h-[490px]">
      <div className="flex justify-between">
        <div className="flex">
          <div className="bg-[#B8F82F] border-black border-solid border-1 w-10 h-7 rounded-sm flex items-center mb-2 ml-8 mr-2">
            ...
            <Image src={Income_Logo} alt="dynamic" />
          </div>
          <div className="dropdown dropdown-bottom dropdown-end">
            <label className="flex text-xs font-normal" tabIndex={0}>
              ...
              <Image src={Arrow} alt="arrow-down" className="ml-1" />
            </label>
            <ul
              tabIndex={0}
      ...
      <h1 className="ml-10 font-light">
        <span className="text-[#B8F82F] text-xl font-semibold mr-1">
          675000
        </span>
        тенге
      </h1>
      <h1 className="ml-10 font-light">
        <span className="text-[#19C20A] text-xl font-semibold mr-1">5000</span>
        тенге
      </h1>
      <BarChart />
...
export default Dynamics_Income;
